...
class TestCalc(unittest.TestCase):
  def setUp(self):
    self.client = Account(forename='Sue', surname='Smith', date_created='10/01/2023')
    self.client2 = Account(forename='Jeff', surname='Garlan', date_created='10/01/2023', balance=100)
  ...
  def test_debit_account(self):
    with self.assertRaises(ValueError):
      self.client.debit(101)
    self.assertEqual(self.client2.debit(100),0)
